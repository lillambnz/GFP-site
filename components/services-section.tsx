...
export default function ServicesSection() {
  ...
  return (
    <section id="services" className="py-20 bg-gradient-to-br from-[#f7f9fc] to-white overflow-hidden">
        ...
        <div className="flex gap-6 services-scroll">
          {duplicatedServices.map((service, index) => {
            ...
            return (
              <div
                key={index}
                className="flex-shrink-0 w-80 bg-white/80 backdrop-blur-sm p-8 rounded-2xl border border-[#e3e8ee] hover:border-[#4a4b75]/20 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 cursor-pointer group"
              >
                <div className="w-14 h-14 bg-gradient-to-br from-[#4a4b75]/10 to-[#4a4b75]/5 rounded-xl flex items-center justify-center mb-6 group-hover:bg-gradient-to-br group-hover:from-[#4a4b75] group-hover:to-[#3a3b65] transition-all duration-300 group-hover:shadow-lg">
