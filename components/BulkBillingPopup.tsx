          ...
          <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="relative px-6 py-5 pb-7 text-center">
              ...
              <p className="text-gray-600 text-sm mb-4 leading-relaxed max-w-sm mx-auto">
                Great news! Gosnells Family Practice will soon be a Medicare Bulk Billing Practice — meaning no out-of-pocket costs for all eligible Medicare card holders.
              </p>
