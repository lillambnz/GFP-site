    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 lg:px-8">
          <SectionHeading
            eyebrow="Health Tips"
            title="Latest Health Tips & News"
            subtitle="Expert health advice and updates from our medical team"
            className="mb-14"
          />
            ...
            {latestPosts.map((post) => (
              <StaggerItem key={post.slug}>
                <Link
                  ...
                  className="block bg-card rounded-2xl overflow-hidden shadow-card hover:shadow-card-hover hover:-translate-y-1 transition-all duration-300 group border border-border h-full"
                >
                  <div className="aspect-video bg-brand-teal-light flex items-center justify-center">
                    <Calendar className="w-12 h-12 text-brand-teal/40" />
                  </div>
                  <div className="p-6">
                    <span className="inline-block bg-brand-teal-light text-brand-teal px-2.5 py-0.5 rounded-full text-xs font-medium mb-3">
                      {post.category}
                    </span>
                    <h3 className="font-semibold text-foreground mb-2 group-hover:text-brand-teal transition-colors line-clamp-2">
                      {post.title}
                    </h3>
          ...
          <Reveal className="text-center">
            <Link href="/blog">
              <Button className="bg-brand-teal hover:bg-brand-teal-dark text-white px-8 py-6 rounded-full shadow-card hover:shadow-card-hover transition-all text-base">
                Read More Articles <ArrowRight className="ml-2 w-4 h-4" />
              </Button>
            </Link>
          </Reveal>
        </div>
