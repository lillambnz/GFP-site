    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-16 pt-48 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none text-muted-foreground">
          ...
          <h3 className="text-xl font-semibold text-muted-foreground mt-6 mb-3">2.1 Personal Information</h3>
          ...
          <h3 className="text-xl font-semibold text-muted-foreground mt-6 mb-3">2.2 Health Information</h3>
          <ul className="list-disc pl-6 space-y-1">
          ...
          <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">3. How We Collect Information</h2>
          ...
          <h3 className="text-xl font-semibold text-muted-foreground mt-6 mb-3">4.1 Healthcare Provision</h3>
          <ul className="list-disc pl-6 space-y-1">
          ...
          <h3 className="text-xl font-semibold text-muted-foreground mt-6 mb-3">4.2 Administrative Purposes</h3>
          <ul className="list-disc pl-6 space-y-1">
          ...
          <h3 className="text-xl font-semibold text-muted-foreground mt-6 mb-3">4.3 Legal and Professional Obligations</h3>
          <ul className="list-disc pl-6 space-y-1">
          ...
          <h3 className="text-xl font-semibold text-muted-foreground mt-6 mb-3">5.1 With Your Consent</h3>
          <ul className="list-disc pl-6 space-y-1">
          ...
          <h3 className="text-xl font-semibold text-muted-foreground mt-6 mb-3">5.2 Required by Law</h3>
          <ul className="list-disc pl-6 space-y-1">
          ...
          <h3 className="text-xl font-semibold text-muted-foreground mt-6 mb-3">5.3 Emergency Situations</h3>
          ...
          <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">7. Use of Artificial Intelligence</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">8. Website Cookies and Analytics</h2>
          ...
          <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">10. Your Rights</h2>
          ...
          <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">11. Data Breach Notification</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">13. Updates to This Policy</h2>
          <p>
          ...
          <div className="bg-muted p-6 rounded-lg mt-4">
            <p className="font-semibold text-foreground">Gosnells Family Practice</p>
            <p>Privacy Officer</p>
          ...
          <h3 className="text-xl font-semibold text-muted-foreground mt-6 mb-3">External Complaints</h3>
          <p>If you are not satisfied with our response to your privacy concern, you may contact:</p>
          <div className="bg-muted p-6 rounded-lg mt-4">
            <p className="font-semibold text-foreground">Office of the Australian Information Commissioner (OAIC)</p>
